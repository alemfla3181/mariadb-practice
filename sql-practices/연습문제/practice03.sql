...
select b.emp_no, concat(b.first_name,' ',b.last_name), a.salary
...
select a.emp_no, concat(b.first_name, ' ', b.last_name ), a.title
...
select concat(a.first_name,' ',a.last_name), b.salary, c.title
